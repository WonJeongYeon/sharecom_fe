...
export const { add, deletedParts, detail, detailParts, modifyParts, modifyDesktop, deletedDesktop, rentalInput, customerDetail, inactive, close } = modalSlice.actions;
