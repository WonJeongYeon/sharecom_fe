...
const DesktopParts = (props) => {
    ...
    return (
        <div className={"DesktopPartsCard"} style={{transition: '0.4s', border: "5px solid", borderRadius: "15px", height: "200px", maxWidth:'19.5rem'}}>
            <TypeBanner
            ...
            >
                ...
                <div style={{fontWeight: '700', fontSize: '1.37rem', height: "100%", width: "100%", textAlign: "center", display: "flex", alignItems: "center", justifyContent: "center"}}>
                {props.type}
                </div>

            </TypeBanner>
            <div style={{paddingLeft:'10px', paddingRight:'10px'}}>
            <div style={{fontWeight:'550', fontSize: '1.1rem'}}>{props.data.name}</div>
            <br/>
            <div>{props.data.serial}</div>
            <br/>
            <div style={{whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis'}}>{props.data.etc}</div>
            </div>
